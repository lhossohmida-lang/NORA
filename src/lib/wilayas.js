/**
 * ALGERIA_WILAYAS — the 58 official Algerian wilayas (2019 administrative map).
 *
 * `code` is the official wilaya number (kept as a zero-padded string so it
 * doubles as a stable Firestore document id for delivery rates).
 */
